PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    ro.vendor.mediatek.version.branch=alps-mp-r0.mp3.tc8sp1 \
    ro.vendor.mediatek.version.release=alps-mp-r0.mp3.tc8sp1-V1_wingtech.xm.r0mp3.k6833v1.64_P31 \
    ...
    sys.haptic.runin=13 \
    sys.haptic.scroll.edge=7,2 \
    sys.haptic.switch=9,2 \
    sys.haptic.tap.light=3,2 \
    sys.haptic.tap.normal=3,2 \
    sys.haptic.trigger.drawer=2,0 \
    telephony.active_modems.max_count=2 \
    vendor.audio.ultrasound.log=0 \
    vendor.audio.ultrasound.mode=0 \
